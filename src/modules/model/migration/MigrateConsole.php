...
#[AsCommand(
    name: 'modal:migrate',
    description: 'Persist a migrations',
    help: 'This command allows you to persist migrate',
)]
class MigrateConsole extends Command
{
    ...
    {
        $results = $this->migrationCommand->doMigrate(
